...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring("Title goes here", "Enter an adjective")
    # Get the player to enter a type of liquid
    liquid= simpledialog.askstring("Title goes here", "Enter a type of liquid")
    # Get the player to enter a body part
    bodypart= simpledialog.askstring("Title your name", "Enter a body part")
    # Get the player to enter a verb
    verb= simpledialog.askstring("Title your name", "Enter a verb")
    # Get the player to enter a place
    place= simpledialog.askstring("Title your name", "Enter a place")
    ...
    messagebox.showinfo("Mad libs story", story)
